...
- Phase 5에서 `docs/project/decisions/DEC-001-order-state-and-stock-policy.md`에 동일 상태 변경 정책을 반영한다.
- Phase 5에서 `docs/project/decisions/DEC-002-stock-concurrency-policy.md`에 주문 row 비관적 락 정책을 반영한다.
